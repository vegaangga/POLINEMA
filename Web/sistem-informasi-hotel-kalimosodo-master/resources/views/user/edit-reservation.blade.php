...
<div class="page-content" style="min-height: 80vh">
    <section class="row">
        ...
        @endif
        <div class="col-12">
            <a href="{{route('user.reservation.index')}}" class="btn btn-outline-secondary mb-4"><i class="fas fa-arrow-left"></i>Kembali</a>
            <div class="card shadow rounded">
                ...
                <div class="card-body">
                    ...
                    <form id="formEditReservation" action="{{ route('user.reservation.update', $data->id)}}" method="POST">
                        @csrf
                        @method('PUT')
