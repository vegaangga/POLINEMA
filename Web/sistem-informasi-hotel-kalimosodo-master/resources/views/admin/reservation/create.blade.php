        ...
        <div class="col-12">
            ...
            <div class="card shadow rounded">
                <div class="card-header">
                    <h5 class="m-0 card-title">Tambah Reservasi</h5>
                </div>
                <div class="card-body">

                    <form id="formAddReservation" action="{{ route('reservation.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="price2">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="check_in">Check-in</label>
                                        <input type="date" class="form-control @error('check_in') is-invalid @enderror" value="{{ old('check_in') }}" id="check_in" name="check_in" placeholder="Enter check_in">
                                        @error('check_in')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('check_out') is-invalid @enderror" value="{{ old('check_out') }}" id="check_out" name="check_out" placeholder="Enter check_out">
                                        @error('check_out')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('guest') is-invalid @enderror" value="{{ old('guest') }}" id="guest" name="guest" placeholder="Enter guest">
                                @error('guest')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly id="set-price">
                            </div>
