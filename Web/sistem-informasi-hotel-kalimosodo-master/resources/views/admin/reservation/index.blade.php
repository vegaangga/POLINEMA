...
<div class="page-content" style="min-height: 80vh">
    <section class="row">
        <div class="col-12">
            <a href="{{route('reservation.create')}}" class="btn btn-primary mb-4"><i class="fas fa-plus"></i>Tambah Reservasi</a>
...
<div class="modal fade text-left" id="editStatusModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form id="formEditStatus" method="PUT">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="body-status">
                        <div class="form-group">
                            <label class="form-check-label" for="is_active">Verifikasi</label>
