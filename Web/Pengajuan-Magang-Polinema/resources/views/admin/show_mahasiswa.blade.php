    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                Data Mahasiswa&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span><a href="{{ route('mahasiswa.create') }}" class="btn btn-info btn-xs"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</a></span>
            </div>
            @if (session('status'))
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex;">
                                <a class="btn btn-success" href="{{ route('mahasiswa.edit', $user->id) }}">Edit</a>&nbsp;
