...
@section('title', 'Buat Kelompok dan Upload Proposal')
    ...
    <div class="col-xs-12">
        <div class="card">
            ...
            <div class="card-body" style="background:white;">
                <form action="{{ route('proposal.store') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @csrf
                    <div class="form-body">
